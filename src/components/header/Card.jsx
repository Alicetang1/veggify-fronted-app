...
const Card = ({item}) => {
  ...
  return (
    <div className='container mx-auto flex justify-canter md:justify-start'>
      <div className='max-w-sm '>
        <div className='relative bg-white shadow-lg hover:shadow-xl transition duration-500 rounded-lg'>
