...
const NewsLetter = () => {
  return (
    <div className='w-full md:w2/3 mx-auto flex flex-col items-center p-10'>
      ...
      <div className='mt-6 flex flex-col md:flex-row items-center justify-center w-full md:px-8 gap-4 mb-20'>
        ...
        <button 
          className='py-4 px-8 hover:bg-btnColor text-secondary hover:text-white w-full transition ease-in duration-200 text-center text-base font-semibold border border-[#9c792a] focus:outline-none rounded-lg'>Get Started</button>
      </div>
      </div>
  )
}
